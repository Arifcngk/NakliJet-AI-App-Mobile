...
// class ApiService {
//   static const String baseUrl = 'http://localhost:3000/api'; // Backend URL’nizi buraya göre ayarlayın
...
//   Future<JobPosting> updateJobPosting(String jobId, JobPosting jobPosting) async {
//     final response = await http.put(
...
//   Future<JobPosting> submitOffer(String jobId, String userId, double offerPrice) async {
//     final response = await http.post(
...
//     final response = await http.get(Uri.parse('$baseUrl/user-jobs?userId=$userId'));
//     if (response.statusCode == 200) {
//       List jsonResponse = json.decode(response.body);
...
//     final response = await http.get(Uri.parse('$baseUrl/vehicles?userId=$userId'));
//     if (response.statusCode == 200) {
//       List jsonResponse = json.decode(response.body);
...
//     final response = await http.get(Uri.parse('$baseUrl/earnings?userId=$userId'));
//     if (response.statusCode == 200) {
